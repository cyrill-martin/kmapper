# Original code at: 
# https://gist.github.com/ibanez270dx/ca13c9d11b9fd8694196
#
...
#     gradient.print
#
#   Slightliy adapted by:
#     Cyrill Martin
#     github.com/cyrill-martin 
#
#     gradient.middle to 'calculate' the color between two colors
#
#####################################################################################
...
class Gradient
  ...
  def middle
    to_hex(generate[(generate.length)/2])
  end
